...
## Стек технологий
* **Язык**: Python 3.10+
* **Тестовый раннер**: Pytest 8.x
* **Сетевой клиент**: Requests (с пулом Keep-Alive соединений и Retry-политикой)
...
![Allure Report Overview](.github/assets/allure_report.jpg)
